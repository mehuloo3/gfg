<h2><a href="https://www.geeksforgeeks.org/problems/sum-of-digits-divisibility5311/1">Sum of Digits Divisibility</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number N. Check whether it is divisible by the sum of its digits or not.</span></p>
