<h2><a href="https://www.geeksforgeeks.org/problems/ishaan-loves-chocolates2156/1?page=2&category=Arrays&sortBy=submissions">Ishaan Loves Chocolates</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">As we know, Ishaan has a love for chocolates. He has bought a huge chocolate bar that contains N chocolate squares. Each of the squares has a tastiness level which is denoted by an array A[].<br>
