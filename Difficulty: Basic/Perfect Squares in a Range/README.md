<h2><a href="https://www.geeksforgeeks.org/problems/perfect-squares-in-a-range2253/1?page=1&category=Mathematical&sortBy=submissions">Perfect Squares in a Range</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given two given numbers <strong>a</strong> and <strong>b</strong> where 1&lt;=a&lt;=b, find the number of perfect squares between a and b (a and b inclusive).</span></p>
