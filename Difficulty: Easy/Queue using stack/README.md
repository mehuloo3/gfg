<h2><a href="https://www.geeksforgeeks.org/problems/queue-using-stack/1?page=1&difficulty%5B%5D=0&category%5B%5D=Queue&sortBy=submissions">Queue using stack</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Implement a Queue&nbsp;using two stack</span><span style="font-size: 18px;"><strong>&nbsp;s1</strong>&nbsp;and<strong>&nbsp;s2</strong>.</span></p>
